function question_page()
{
            ...
            { margin:5, cols:[
                {
                     view:"button", value:"Подтвердить" , css:"webix_primary",  click:function(id,event){
                            ...
                            webix.ajax().post("https://api.messagebotfarm.ru/formvalues",formvalues).then(function()
                            {
                                   $$('window').close()
                                   $$('datatable').load("https://api.messagebotfarm.ru/hello")        
                           });
    ...
    },
    {
        ...
        onClick:{"custom_trash":function(e,id,node){            
            ...
            .then(function(){
                webix.ajax().post("https://api.messagebotfarm.ru/deleteform",id).then(function()
                         {
                                $$('datatable').clearAll()
                                $$('datatable').load("https://api.messagebotfarm.ru/hello")            
                        });        
        ...
        columns:[
            ...
            { id:"type",   header:"Тип ответа",   width:120},
        ...
        url:"https://api.messagebotfarm.ru/hello"
    } 
