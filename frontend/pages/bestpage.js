function bestpage_page()
{
      ...
      rows:[
    {
                    ...
                    { margin:5, cols:[
                        {
                             view:"button", value:"Подтвердить" , css:"webix_primary",  click:function(id,event){
                                    ...
                                    webix.ajax().post("http://localhost:3000/offertextstart",formvalues6).then(function()
                                    {
                                           $$('window').close()
                                           $$('datatable1').load("http://localhost:3000/hello6")        
                                   });
                        }
                    },
                    ]}
        ...
        url:"http://localhost:3000/hello6"
    },
    {
        view:"datatable",
        id:"datatable2",
        ...
        url:"http://localhost:3000/topnull"
    }, 

    {
        ...
        url:"http://localhost:3000/topstandart"
    },
    {
        view:"datatable",
        id:"datatable5",
        ...
        url:"http://localhost:3000/topbad"
    },

    {
                    ...
                    { margin:5, cols:[
                        {
                             view:"button", value:"Подтвердить" , css:"webix_primary",  click:function(id,event){
                                    ...
                                    webix.ajax().post("http://localhost:3000/offertextend",formvalues7).then(function()
                                    {
                                           $$('window').close()
                                           $$('datatable4').load("http://localhost:3000/hello7")        
                                   });
        ...
        url:"http://localhost:3000/hello7"
    } 
