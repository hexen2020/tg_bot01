function offers_page()
{
    ...
    function editform(item) {
        ...
        elements:[
            ...
            { view:"select", label:"Продвигать в популярных предложениях?", name:"top", labelPosition:"top", options:[
                {"value":"" },
                {"value":"Да, под 0" },
                {"value":"Да, под обычный процент" },
                {"value":"Да, с плохой кредитной историей" },
            ]},
        ...
        rows:[
            {
                ...
                columns:[
                    ...
                    { id:"top",   header:"Продвигать в популярных предложениях?",   fillspace:true},
                    {id:"delete", 
                    header:"&nbsp;", 
                    width:99, 
