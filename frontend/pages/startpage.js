function startpage_page()
{
            ...
            { margin:5, cols:[
                {
                     view:"button", value:"Подтвердить" , css:"webix_primary",  click:function(id,event){
                            ...
                            webix.ajax().post("https://api.messagebotfarm.ru/startpageformvalues",formvalues5).then(function()
                            {
                                   $$('window').close()
                                   $$('datatable').load("https://api.messagebotfarm.ru/hello5")        
                           });
      ...
      rows:[
    {
        ...
        url:"https://api.messagebotfarm.ru/hello5"
    } 
